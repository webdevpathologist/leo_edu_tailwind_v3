  ...
  return (
    <div className={`text-1xl flex items-center justify-between px-1 ${page_para_text} dark:${page_para_text_dark} lg:shadow-sm`}>
      <p className="leading-relaxed">
        ...
        <br />
        <br />
        To achieve it in an optimal way, we have established associations with <a target={"_blank"} rel='noreferrer' className="underline decoration-2 box-decoration-slice decoration-green-600 font-bold dark:decoration-zinc-200/90 hover:animate-pulse" href="https://brainybobs.in/">reputed organizations</a> specializing in abacus, calligraphy, brain gym,
