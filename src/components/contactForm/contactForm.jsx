...
export default function ContactForm(props) {
  ...
  const form_head_text_dark = "text-green-300/95"
  ...
  return (
    ...
    <div className={`relative z-20 mt-10 flex w-full flex-col rounded-lg bg-indigo-200 p-4 shadow-md dark:bg-slate-800/95 ${form_head_text} dark:${form_head_text_dark} md:ml-auto md:mt-0 md:w-1/2 lg:w-1/3`}>
      <form className="px-8 py-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          className="mt-4 mb-4 w-full rounded-full border-2 border-indigo-500 dark:border-green-500 bg-transparent px-1 py-1 text-sm uppercase transition-colors duration-200 hover:bg-indigo-500 hover:text-gray-100 dark:hover:bg-green-500 dark:hover:text-gray-100 focus:border-4 focus:border-indigo-400 dark:focus:border-green-300"
          type="submit"
        >
          Submit
        </button>
